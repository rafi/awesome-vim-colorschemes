function! airline#themes#deus#refresh()
  ...
  let s:N1 = [ '#232a32', '#98C379', s:term_black, s:term_green ]
  let s:N2 = [ '#ABB2BF', '#3E4452', s:term_white, s:term_grey ]
  let s:N3 = [ '#98C379', '#232a32', s:term_green, '' ]
  ...
  let s:I1 = [ '#232a32', '#61AFEF', s:term_black, s:term_blue ]
  let s:I2 = s:N2
  let s:I3 = [ '#61AFEF', '#232a32', s:term_blue, '' ]
  ...
  let s:R1 = [ '#232a32', '#E06C75', s:term_black, s:term_red ]
  let s:R2 = s:N2
  let s:R3 = [ '#E06C75', '#232a32', s:term_red, '' ]
  ...
  let s:V1 = [ '#232a32', '#C678DD', s:term_black, s:term_purple ]
  let s:V2 = s:N2
  let s:V3 = [ '#C678DD', '#232a32', s:term_purple, '' ]
  ...
  let s:IA1 = [ '#232a32', '#ABB2BF', s:term_black, s:term_white ]
  ...
  " Warnings
  let s:WI = [ '#232a32', '#E5C07B', s:term_black, s:term_yellow ]
  ...
  " Errors
  let s:ER = [ '#232a32', '#E06C75', s:term_black, s:term_red ]
