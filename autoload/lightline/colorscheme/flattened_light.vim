if exists('g:lightline')
	...
	let s:base00  = ['#839496', '244']
	let s:base01  = ['#93a1a1', '245']
	let s:base02  = ['#eee8d5', '187']
	let s:base03  = ['#fdf6e3', '230']
	let s:base0   = ['#657b83', '240']
	let s:base1   = ['#586e75', '239']
	let s:base2   = ['#073642', '235']
	let s:base3   = ['#002b36', '234']
